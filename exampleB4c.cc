...
int main(int argc,char** argv)
{
 ...
 // runManager->SetUserInitialization(physicsList);
  ...
  if ( macro.size() ) {
    ...
    //UImanager->ApplyCommand("/vis/viewer/zoom 4");
    //UImanager->ApplyCommand("/vis/viewer/set/viewpointVector -1 0.75 1");
    //UImanager->ApplyCommand("/vis/viewer/set/viewpointThetaPhi 45. 135.");
    UImanager->ApplyCommand("/control/execute vis_new.mac");
    ui->SessionStart();
    delete ui;
  }
